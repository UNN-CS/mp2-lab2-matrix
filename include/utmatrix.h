...
template <class ValType>
TVector<ValType>::TVector(TVector<ValType> &&v) : Size(v.Size), StartIndex(v.StartIndex), pVector(v.pVector)
{
	v.Size = 0;
	v.StartIndex = 0;
	v.pVector = nullptr;
...
{
	if (((pos - GetStartIndex()) < 0) || ((pos - GetStartIndex()) >= Size)) throw - 1;
	return pVector[(pos - GetStartIndex())];
} /*-------------------------------------------------------------------------*/
...
TMatrix<ValType>::TMatrix(int s) : TVector<TVector<ValType> >(s)
{
	...
	for (int i = 0;i < this->Size;i++)
		this->pVector[i] = move(TVector<ValType>(this->Size - i, i));
} /*-------------------------------------------------------------------------*/
